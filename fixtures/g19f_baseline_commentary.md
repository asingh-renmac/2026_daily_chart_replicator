...
replacement baseline for the earlier 2026-09-04 commentary, which is gone.
...
Charts 5, 8 and 10 are the compound-transform cases that motivated §15.1b: a 3-month
moving average **of the monthly change**, which the flat phrase mapper silently
collapsed to a 3mma of the level. Chart 7 carries two transforms on one ticker, the
legend-collision case §15.1a re-keys. Chart 4 is the §15.1d case: "2-quarter" bound to
a monthly series must become six native periods, not two.
